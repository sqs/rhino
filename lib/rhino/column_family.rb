module Rhino
  ...
  # Rhino::Base.column_family, a family's child columns can change from row to row. A ColumnFamily instance lets you see which child columns,
  ...
  # You may also access the value of the column with <tt>Rhino::Base#get_attribute(column_name)</tt>.
